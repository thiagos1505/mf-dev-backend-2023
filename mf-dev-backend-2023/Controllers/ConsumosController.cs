...
namespace mf_dev_backend_2023.Controllers
{
    public class ConsumosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,VeiculoId,Data,Valor,Km,combustivel")] Consumo consumo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,VeiculoId,Data,Valor,Km,combustivel")] Consumo consumo)
        {
            if (id != consumo.Id)
            {
                return NotFound();
